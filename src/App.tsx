...
function App() {
  ...
  const appearanceMode = useAppearance(settings.appearance_mode)
  ...
  const handleToggleAppearance = useCallback(() => {
    ...
    void saveSettings({
      ...settings,
      appearance_mode: nextAppearanceMode,
    })
  }, [appearanceMode, saveSettings, settings])

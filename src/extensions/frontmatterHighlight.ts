...
export function frontmatterHighlightTheme(isDark = false) {
  const keyColor = isDark ? '#ff8f8f' : '#c9383e'
  const valueColor = isDark ? '#7ed9a8' : '#2a7e4f'
  const delimiterColor = isDark ? '#ff8f8f' : '#c9383e'
